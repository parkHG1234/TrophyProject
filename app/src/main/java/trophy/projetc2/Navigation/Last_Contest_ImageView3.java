...
public class Last_Contest_ImageView3 extends Fragment {

    ImageView Last_Contest_ImageView3;
    private String num;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View rootView = inflater.inflate(R.layout.layout_last_contest_imageview3, container, false);


        Last_Contest_ImageView3 = (ImageView)rootView.findViewById(R.id.Last_Contest_ImageView3);

...
public class Last_Contest_ImageView11 extends Fragment {
    private String Pk;

    public Last_Contest_ImageView11(String Pk) {
        this.Pk = Pk;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Glide.with(getContext()).load("http://210.122.7.193:8080/Trophy_img/last_contest/" + Pk + "11.jpg")
        ...
        Last_Contest_ImageButton_Save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String imgUrl = "http://210.122.7.193:8080/Trophy_img/last_contest/" +  Pk + "11.jpg";

...
public class TeamSearch_Focus_Customlist_MyAdapter extends BaseAdapter{
    ...
    String ProfileUrl;
    public TeamSearch_Focus_Customlist_MyAdapter(Context c, ArrayList<TeamManager_PlayerManager_Customlist_MyData_Player> arr) {
        this.context = c;
        this.arrData = arr;

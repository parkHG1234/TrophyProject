...
public class TeamSearch_Focus_MyAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<TeamSearch_Focus_MyData> arrData;
    ...
    String ProfileUrl;
    public TeamSearch_Focus_MyAdapter(Context c, ArrayList<TeamSearch_Focus_MyData> arr) {
        this.context = c;
        this.arrData = arr;

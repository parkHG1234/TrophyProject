    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try{
                ...
                if(En_Profile.equals("."))
                {
                    Glide.with(context).load(R.drawable.profile_basic_image).diskCacheStrategy(DiskCacheStrategy.NONE)
                            .skipMemoryCache(true).into(FirstProfile);
                }
                else
                {
        ...
        if(SecondProfile.getVisibility()==View.VISIBLE){
            try{
                ...
                {
                    Glide.with(context).load(R.drawable.profile_basic_image).diskCacheStrategy(DiskCacheStrategy.NONE)
                            .skipMemoryCache(true).into(SecondProfile);
                }
                else
                {
                    Glide.with(context).load("http://210.122.7.193:8080/Trophy_img/profile/"+En_Profile+".jpg").diskCacheStrategy(DiskCacheStrategy.NONE)
        ...
        if(ThirdProfile.getVisibility()==View.VISIBLE){
            try{
                ...
                {
                    Glide.with(context).load(R.drawable.profile_basic_image).diskCacheStrategy(DiskCacheStrategy.NONE)
                            .skipMemoryCache(true).into(ThirdProfile);
                }
                else
                {
                    Glide.with(context).load("http://210.122.7.193:8080/Trophy_img/profile/"+En_Profile+".jpg").diskCacheStrategy(DiskCacheStrategy.NONE)
        ...
        if(FourthProfile.getVisibility()==View.VISIBLE){
            try{
                ...
                {
                    Glide.with(context).load(R.drawable.profile_basic_image).diskCacheStrategy(DiskCacheStrategy.NONE)
                            .skipMemoryCache(true).into(FourthProfile);
                }
                else
                {
                    Glide.with(context).load("http://210.122.7.193:8080/Trophy_img/profile/"+En_Profile+".jpg").diskCacheStrategy(DiskCacheStrategy.NONE)

...
public class TeamManager_PlayerManager extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String result1 = http_Player.HttpClient("Trophy_part1","TeamManager_Player.jsp",TeamName);
                ...
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(refresh_player.equals("refresh")){
                            HttpClient http_Player= new HttpClient();
                            String result = http_Player.HttpClient("Trophy_part1","TeamManager_Player.jsp",TeamName);
        ...
        timer.schedule(myTask, 500, 2000); // 5초후 첫실행, 3초마다 계속실행
        return rootView;
    }
    ...
    private void setData_Joiner()
    {
        ...
        if(Extra==0){
            ...
            TeamManager_PlayerManager_Customlist_MyData_Joiner.add(new TeamManager_PlayerManager_Customlist_MyData_Joiner(parsedData_Joiner[(3*Row)][0],parsedData_Joiner[(3*Row)][1],parsedData_Joiner[(3*Row)][2],"null","null","null","null","null","null"));
        }else if(Extra==2){
            TeamManager_PlayerManager_Customlist_MyData_Joiner.add(new TeamManager_PlayerManager_Customlist_MyData_Joiner(parsedData_Joiner[(3*Row)][0],parsedData_Joiner[(3*Row)][1],parsedData_Joiner[(3*Row)][2],parsedData_Joiner[(3*Row)+1][0],parsedData_Joiner[(3*Row)+1][1],parsedData_Joiner[(3*Row)+1][2],"null","null","null"));
        }
    }

...
/**
 * Created by 박효근 on 2017-06-07.
 */

public class OutCourt_CourtInfo_Main extends AppCompatActivity{
   ...
   ;static String Address_Do = "";static String User_Pk = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OutCourt_CourtInfo_TextView_Title.setText(Address_Do);
        ...
        String result = http_match.HttpClient("Trophy_part1","OutCourt_Do.jsp", Address_Do, strCurToday);
        parsedData_Match = jsonParserList_Match(result);
        if(parsedData_Match[0][0] == "."){
        }else{
            for (int j = 0; j < parsedData_Match.length; j++) {
                OutCourt_CourtInfo_MyData.add(new OutCourt_CourtInfo_MyData(parsedData_Match[j][0], parsedData_Match[j][1] + "  " + parsedData_Match[j][2],parsedData_Match[j][5],OutCourt_CourtInfo_Main.this,User_Pk,parsedData_Match[j][3],parsedData_Match[j][4]));
            }
        }

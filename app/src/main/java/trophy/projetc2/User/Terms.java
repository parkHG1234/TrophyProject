...
public class Terms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User_Terms_TextView_Agree1.setText("제1조(목적) 이 약관은 ‘바스켓북’ 회사(전자상거래 사업자)가 운영하는 ‘오늘의농구’ 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.\n" +
                "\n" +
                ...
                "\n" +
                "  ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 ‘오늘의농구’ 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.\n" +
                "\n" +
        ...
        User_Terms_TextView_Agree2.setText("1. 개인정보의 처리 목적 <오늘의 농구>(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.\n" +
                "- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등\n" +
                "\n" +
                "\n" +
                "2. 개인정보의 처리 및 보유 기간\n" +
                "\n" +
                "① <오늘의 농구>(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP’) 은(는) 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유․이용기간 또는 법령에 따른 개인정보 보유․이용기간 내에서 개인정보를 처리․보유합니다.\n" +
                "\n" +
                ...
                "3. 개인정보처리 위탁\n" +
                "\n" +
                "① <오늘의 농구>('오늘의 농구 APP')은(는) 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.\n" +
                "\n" +
                "② <오늘의 농구>('https://play.google.com/store/'이하 '오늘의 농구 APP')은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.\n" +
                "\n" +
                ...
                "\n" +
                "① 정보주체는 <기관/회사명>('오늘의 농구') 에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.\n" +
                "1. 개인정보 열람요구\n" +
                "2. 오류 등이 있을 경우 정정 요구\n" +
                "3. 삭제요구\n" +
                "4. 처리정지 요구\n" +
                ...
                "5. 처리하는 개인정보의 항목 작성 \n" +
                "\n" +
                "① <오늘의 농구>('https://play.google.com/store/'이하 '오늘의 농구 APP')은(는) 다음의 개인정보 항목을 처리하고 있습니다.\n" +
                "\n" +
                "1<가입하는 팀에게 개인정보 제공>\n" +
                ...
                "\n" +
                "\n" +
                "6. 개인정보의 파기<오늘의 농구>('오늘의 농구 APP')은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.\n" +
                "\n" +
                ...
                "\n" +
                "\n" +
                "7. 개인정보의 안전성 확보 조치 <오늘의 농구>('오늘의 농구 APP')은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.\n" +
                "\n" +
                "1. 내부관리계획의 수립 및 시행\n" +
                ...
                "\n" +
                "\n" +
                "① 오늘의 농구(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP) 은(는) 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.\n" +
                "\n" +
                "▶ 개인정보 보호책임자 \n" +
                "성명 :박효근\n" +
                "직책 :대표\n" +
                ...
                "② 정보주체께서는 오늘의 농구(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP) 의 서비스(또는 사업)을 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. 오늘의 농구(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP) 은(는) 정보주체의 문의에 대해 지체 없이 답변 및 처리해드릴 것입니다.\n" +
                "\n" +
                "\n" +
                "\n" +
                "9. 개인정보 처리방침 변경\n" +
        ...
        User_Terms_TextView_Agree3.setText("1. 개인정보의 처리 목적 <오늘의 농구>(‘https://play.google.com/store/’이하 ‘오늘의 농구 APP’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는 이용하지 않습니다.\n" +
                "- 고객 가입의사 확인, 고객에 대한 서비스 제공에 따른 본인 식별.인증, 회원자격 유지.관리, 물품 또는 서비스 공급에 따른 금액 결제, 물품 또는 서비스의 공급.배송 등\n" +
                "\n" +
                "\n" +
                "2. 개인정보의 처리 및 보유 기간\n" +
